...
class ViewController: UIViewController, UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        ...
        getBitCoinValue(url: finalURL, row : row)
    }
...
//    /***************************************************************/
//    
    func getBitCoinValue(url: String, row : Int) {
        ...
        Alamofire.request(url, method: .get)
            .responseJSON { response in
                if response.result.isSuccess {
                    ...
                    self.updateBitCoinValue(json: bitCoinValueJSON, row : row)
...
//    /***************************************************************/
//    
    func updateBitCoinValue(json : JSON, row : Int) {
        
        if let tempResult = json["averages"]["day"].double {
            bitcoinPriceLabel.text = "\(currencySymbolsArray[row]) \(tempResult)"
        }
        else {
